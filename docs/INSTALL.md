...
The current release is **v0.1.7**, published with signed, reproducible archives for
...
[`packaging/aur/PKGBUILD`](https://github.com/Nastwinns/hawser/blob/main/packaging/aur/PKGBUILD):
...
- `haw-0.1.7-x86_64-unknown-linux-musl.tar.gz` (static)
